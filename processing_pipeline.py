...
def main():
    ...
    # step11: PCA
    # data_processing.pca_option_op1(path_in='./merged_data5/stacked_3.csv', path_out='./merged_data5/pca_op1.csv')  # TODO which one??
    # data_processing.pca_option_op2(path_in='./merged_data5/stacked_3.csv', path_out='./merged_data5/pca_op2.csv')
    data_processing.pca_option(path_in='./merged_data5/stacked_3.csv', path_out='./merged_data5/pca4.csv')
