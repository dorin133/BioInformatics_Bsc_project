...
def main():
    ...
    # data_processing.prepare_metadata_single_files(folder_path='./raw_data', out_folder_path='./raw_csv_data')
    ...
    # data_processing.filter_metadata_rows(folder_mtx_path='./filtered_data',folder_to_metadata='./raw_csv_data' ,out_folder_path='./filtered_data')
    ...
    # step 6: after filtering and normalizing seperately, merge all files together
