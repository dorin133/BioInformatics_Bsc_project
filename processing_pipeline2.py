...
def main():
    ...
    # step 3: filter both matrices and metadatas of each sample seperately
    ...
    data_processing2.filter_unwanted('./gaba_merged_data10/gaba_stacked_2_v2.csv',
    ...
    comparing_groups.size_of_clusters(path_in='./gaba_clustered_data11/gaba_all_samples_stats.csv')

    # step 20: split tables according to groups
    comparing_groups.split_clusters_and_groups(path_in_data='./gaba_merged_data10/gaba_stacked_3.csv',  # assume stacked_3, but might want stacked_2/2_v3
    ...
    comparing_groups.ranksum_plot(folder_in='gaba_groups12',
                                  res_out='./gaba_clustered_data11/ranksum_res.csv',
                                  path_to_features='./csv_data2/features.csv',
                                  plots_folder='./plots_folder1/part4')
    comparing_groups.ranksum_present_results('./gaba_clustered_data11/ranksum_res.csv',
                                             './gaba_clustered_data11/ranksum_top_10.csv')
